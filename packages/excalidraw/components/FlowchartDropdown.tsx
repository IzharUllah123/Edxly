...
const FlowchartDropdown = ({ addElementsViaAction }: FlowchartDropdownProps) => {
...
const [openGraphSection, setOpenGraphSection] = useState(false);
  ...
  const generateFlowchart = () => {
    ...
    try {
      ...
      // 2. Set visibility to false to hide the component.
      setIsVisible(false);
...
//             <button
//               onClick={() => {
//                 const elements = blueprintToElements(nodes, edges);
//                 addElementsViaAction(elements);
//               }}
//               className="ffd-option-btn ffd-flow2"
//             >
//               Flowchart 2
//             </button>
//           </div>
...
//         {/* // In the flowcharts section, after Flowchart 2 button: */}
// <button
//   onClick={generateFlowchart3}
//   disabled={isGenerating}
//   className={`ffd-option-btn ffd-flow3 ${isGenerating ? "ffd-disabled" : ""}`}
// >
//   {isGenerating ? "Generating..." : "Flowchart 3"}
// </button>
